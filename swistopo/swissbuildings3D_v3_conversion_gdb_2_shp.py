...
def main() -> None:
    ...
    #path = Path("/Volumes/My Passport Pro/TEMP/PNR_Trient_test/swisstopo")
    ...
    lst_gdbs = [str(gdb) for gdb in pth.parent.rglob('*.gdb')]

    gdbs2shp(lst_gdbs,path_to_ogr2ogr,xmin,zmin,xmax,zmax)
