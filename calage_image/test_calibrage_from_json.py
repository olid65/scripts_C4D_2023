...
#ATTENTION lors de la première exécution il y a un warning :
...
#mais si on relance ça fonctionne ...
...
class CalibrageCamera(object):
    ...
    def estimatePose(self,xyz,uv1):
        ...
        print('roll : ',c4d.utils.Deg(self.roll))
...
def main() -> None:
    ...
    fn = '/Users/olivierdonze/switchdrive/Cinema4d_python/calibrage_camera_tests/ville_aerienne_1896/calibrage_avec_od_calibrator.json'
    ...
    tuple2vec = lambda t : c4d.Vector(t[0],t[1],t[2])

    uvs = [c4d.Vector(x,y,z) for x,y,z in data['uvs']]
    pts3D = [c4d.Vector(x,y,z) for x,y,z in data['pts3D']]

    bmp = c4d.bitmaps.BaseBitmap()
    bmp.InitWith(fn_img)
    #print(bmp.GetSize())
    calib = CalibrageCamera(bmp,uvs,pts3D)

    doc.InsertObject(calib.camera)
    c4d.EventAdd()
